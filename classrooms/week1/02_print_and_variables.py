...
def variables_test():
    ...
    # The variable names cannot contain special characters.
    # The variable names cannot be any of the reserved keywords.
    # The variables can be declared without any type.
    # The variables can be declared with a type.
    # The variables can be declared with a value.
    # The variables can be declared with a type and a value.

    # variable types in Python are:
    # int, float, str, bool, list, tuple, dict, set, frozenset, bytes, bytearray, memoryview, None, path, os_name
    ...
    print(f"Variable: var_memoryview_1 | Value: {var_memoryview_1} | Type: {type(var_memoryview_1)}")
    print(f"Variable: var_none_1 | Value: {var_none_1} | Type: {type(var_none_1)}")
    print(f"Variable: var_path_1 | Value: {var_path_1} | Type: {type(var_path_1)}")
    print(f"Variable: var_os_name_1 | Value: {var_os_name_1} | Type: {type(var_os_name_1)}")
